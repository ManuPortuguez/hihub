...
import PlaneSh from '@/images/plane-sh.png';
import TrollySh from '@/images/trolly-sh.png';
import TestimonialFt from '@/images/testimonial-ft.jpg';
import TextAnimation from '@/components/elements/TextAnimation';
import FadeInAdvanced from '@/components/elements/FadeInAdvanced';

export default function ReviewSec() {
   const swiperRefReview = useRef<SwiperType | null>(null);

   // Navigation handlers for slider
   const reviewNextSlide = (): void => {
      swiperRefReview.current?.slideNext();
   };

   const reviewPrevSlide = (): void => {
      swiperRefReview.current?.slidePrev();
   };

   return (
      <>
         {/* Testimonial Section Start */}
         <section className="review-sec sec-padding position-relative overflow-hidden">
            <img src={PlaneSh} className="anim-img left-bottom" alt="Plane decoration" />
            <img src={TrollySh} className="anim-img moveXS right-bottom" alt="Trolly decoration" />
            <div className="container">
               <div className="row">
                  <div className="col-lg-4">
                     <FadeInAdvanced variant='slideInLeft' >
                        <div className="review-thumb">
                           <img className="img-fluid" src={TestimonialFt} alt="review" />
                        </div>
                     </FadeInAdvanced>
                  </div>
                     ...
                     <div className="review-wrapper">
                        ...
                        <div className="review-slider swiper">
                           <div className="swiper-wrapper">
                              <Swiper
                                 onSwiper={(swiper) => {
                                    swiperRefReview.current = swiper;
                                 }}
                           ...
                           <div onClick={reviewNextSlide} className="swiper-button-next"></div>
                           <div onClick={reviewPrevSlide} className="swiper-button-prev"></div>
                           {/* Custom Pagination */}
