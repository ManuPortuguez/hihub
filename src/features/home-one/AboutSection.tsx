import AboutSh from "@/images/about-sh.png";
...
export default function AboutSection() {
    return (
        <>
            {/* About Section Start */}
            <section className="about-section position-relative sec-padding">
                <img src={AboutSh} alt="shape" className="anim-img moveY" />
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="about-media position-relative">
                                <div className="about-m1">
                                    <img
                                        className="round img-fluid"
                                        src={About1}
                                        alt="Equipo HiHub Global"
                                    />
                                </div>
                                <div className="about-m2">
                                    <img className="img-fluid" src={About2} alt="Operaciones en China" />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="about-content">
                                ...
                                <h2 className="sec-title">
                                    <TextAnimation animationStyle="style1">
                                        Tu Socio de Confianza para Proyectos Complejos en China
                                    </TextAnimation>
                                </h2>
                                <p>
                                    HiHub Global Technologies ayuda a las empresas a tener éxito en
                                    China, especialmente cuando los riesgos son altos. Desde contratos
                                    gubernamentales hasta operaciones técnicamente exigentes,
                                    gestionamos abastecimiento, producción y logística con confianza y
                                    precisión.
                                </p>
                                <p>
                                    Con sólidas redes locales y profundo conocimiento de la industria,
                                    HiHub está construido para entregar resultados, incluso en los
                                    entornos más desafiantes.
                                </p>
                                <ul className="check">
                                    <li>
                                        Gestión integral de abastecimiento, producción y logística.
                                    </li>
                                    <li>
                                        Presencia local para asegurar operaciones seguras y conformes.
                                    </li>
                                </ul>
                            </div>
                        </div>
