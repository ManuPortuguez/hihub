...
export default function ProcessSec() {
    return (
        <>
            ...
            <section className="process-sec sec-padding position-relative overflow-hidden">
                <img
                    src={SlideSh1}
                    alt="shape"
                    className="abs-img  end-0 top-0"
                />
                <div className="container">
                    ...
                    <div className="process-wrapper d-flex justify-content-between flex-wrap mt-5">
                        <FadeInAdvanced variant="fadeInUp" delay={150}>
                            <div
                                className="process-card text-center fadeInUp"
                            >
                                <span className="count mx-auto icon-lg bg-shade rounded-circle">
                                    01
                                </span>
                                <div className="process-thumb rounded-circle d-flex align-items-center justify-content-center">
                                    <img src={St1} alt="request pickup" />
                                </div>
                                <h3 className="display-4">Select Services</h3>
                                <p>
                                    Lorain Air freight service deliver knowledge
                                    opportunity
                                </p>
                            </div>
                        </FadeInAdvanced>
                        ...
                        <FadeInAdvanced variant="fadeInUp" delay={500}>
                            ...
                            >
                                ...
                                <div className="process-thumb rounded-circle d-flex align-items-center justify-content-center">
                                    <img src={St2} alt="request pickup" />
                                </div>
                                <h3 className="display-4">Parcel Information</h3>
                                <p>
                                    Lorain Air freight service deliver knowledge
                                    opportunity
                                </p>
                        ...
                        <FadeInAdvanced variant="fadeInUp" delay={900}>
                            <div
                                className="process-card text-center fadeInUp"
                            >
                                <span className="count mx-auto icon-lg bg-shade rounded-circle">
                                ...
                                <div className="process-thumb rounded-circle d-flex align-items-center justify-content-center">
                                    <img src={St3} alt="request pickup" />
                                </div>
                                <h3 className="display-4">Transportation</h3>
                                <p>
                                    Lorain Air freight service deliver knowledge
                                    opportunity
                                </p>
