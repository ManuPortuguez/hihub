...
import TrackingBg from "@/images/tracking-bg.jpg";

export default function TrackingCtaSec() {
    return (
        <>
            <JarallaxSection
                imgSrc={TrackingBg}
                className="tracking-cta-sec jarallax"
                speed={.2}
            >
                <div className="container" id="contacto">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="tracking-wrapper text-center text-info">
                                ...
                                <FadeInAdvanced variant="fadeInUp" >
                                    <div className="tracking-form2 fadeInUp">
                                        <p>
                                            Elige los servicios que te interesan y nosotros nos encargaremos del resto.
                                        </p>
                                        <div className="row mt-4 text-start">
                                            <div className="col-md-4">
                                                <h3 className="h5 text-info">HiHub Global</h3>
                                                <p className="mb-0">HIHUB GLOBAL TECHNOLOGIES</p>
                                                <p>
                                                    Conectando tu negocio con el corazón de la manufactura e innovación china.
                                                </p>
                                            </div>
                                            <div className="col-md-4">
                                                <h3 className="h5 text-info">Contacto</h3>
                                                <p className="mb-1">hihubtrade@outlook.com</p>
                                                <p className="mb-1">+86 18958020517</p>
                                                <p>Shanghai, China</p>
                                            </div>
                                            <div className="col-md-4">
                                                <h3 className="h5 text-info">Dirección</h3>
                                                <p>
                                                    Room 206, Building 288, Lane 1588, Zhuguang Road, Qingpu District,
                                                    Shanghai, China
                                                </p>
                                            </div>
                                        </div>
