...
import { monthlyPricingData, yearlyPricingData } from "@/data/pricingData";

export default function PricingSec() {
    const [isYearly, setIsYearly] = useState(false);

    const activeData = isYearly ? yearlyPricingData : monthlyPricingData;

    return (
        <>
            {/* Pricing Section Start */}
            <section className="pricing-sec bg-shade sec-padding position-relative">
                <div className="container">
                    <div className="sec-intro full mx-auto text-center">
                    ...
                    <div className="tv-pricing-nav-wrapper position-relative">
                        <label
                            className={`tv-toggler ${!isYearly ? "is-active" : ""}`}
                            id="tv-nav-monthly"
                        ...
                        <div className="tv-toggle-input-wrap">
                            <input
                                type="checkbox"
                                id="tv-switcher-input"
                                className="tv-input-check"
                                checked={isYearly}
                                onChange={() => setIsYearly(!isYearly)}
                            />
                            <b className="tv-switch-toggle"></b>
                        </div>
                        <label
                            className={`tv-toggler ${isYearly ? "is-active" : ""}`}
                            id="tv-nav-yearly"
                        ...
                        >
                            Yearly
                            <sup className="text-primary">Save 25%</sup>
                        </label>
                    </div>
                    <div className="tv-pricing-tab-item">
                        <div className="row gy-4 gy-lg-0 mt-5 justify-content-md-center">
                            {activeData.map((plan) => (
                                <div className="col-lg-4 col-md-6" key={plan.id}>
                                    <div className="pricing-card bg-info rounded-2">
                                        ...
                                        <div className="pricing-body">
                                            ...
                                            <Link
                                                to={plan.link}
                                                className="btn d-block mt-5 btn-dark"
                                            >
                                                Get Started
