...
export default function RecentWork() {
    const swiperRefWork = useRef<SwiperType | null>(null);
    return (
        <>
            {/* Recent Section Start */}
            <section className="recent-work sec-padding">
                <div className="sec-intro mx-auto text-center">
                    ...
                    <h2 className="sec-title">Explore Our Recent Work</h2>
                </div>
                <div className="work-carousel swiper">
                            ...
                            {recentWorkData.map((work) => (
                                <SwiperSlide key={work.id}>
                                    <div className="pt-item">
                                        <img className="img-fluid" src={work.image} alt={work.title} />
                                        <div className="pt-hover">
                                            <div className="pt-inner">
                                                <Link
                                                    to={work.link}
                                                    className="icon-lg bg-dark text-info rounded-2"
                                                >
                                                    <i className="fa fa-arrow-right"></i>
                                                </Link>
                                                <div className="pt-footer">
                                                    <span className="cat-meta text-info">
                                                        <a
                                                            className="text-reset"
                                                            href={work.categoryLink}
                                                        >
                                                            {work.category}
                                                        </a>
                                                    </span>
