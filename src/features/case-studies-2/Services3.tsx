...
import { services3Data } from "@/data/projectsData";
...
export default function Services3() {
    return (
        <>
            ...
            <section className="services-3 case-2 sec-padding overflow-hidden">
                <div className="container">
                    <div className="sec-intro mx-auto text-center">
                        <span className="sub-title fadeInUp">
                            ...
                            <TextAnimation>Our Case-studies</TextAnimation>

                        </span>
                        <h2 className="sec-title">
                            <TextAnimation>Boost Your Business Efficiency</TextAnimation>
